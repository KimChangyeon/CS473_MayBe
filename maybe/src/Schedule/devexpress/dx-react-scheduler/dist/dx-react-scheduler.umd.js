...
(function (global, factory) {
    ...
    ***************************************************************************** */
            ...
            return (React.createElement(dxReactCore.Plugin, { name: "Appointments", dependencies: pluginDependencies$2 },
                ...
                React.createElement(dxReactCore.Template, { name: "appointmentContent" }, function (_a) {
                    ...
                    return (React.createElement(Appointment, __assign({ data: data }, dxCore.createClickHandlers(onClick, onDoubleClick), restParams),
                        ...
                        React.createElement(AppointmentContent, { data: data, type: type, durationType: durationType, recurringIconComponent: recurringIconComponent, formatDate: formatDate }),
    ...
    var renderAppointmentItems = function (items, formatDate, data, Wrapper, Appointment) { return (items.length > 0 ? (React.createElement(Wrapper, null, items.map(function (_a, index) {
        ...
        return (React.createElement(Appointment, { key: index.toString(), data: data, durationType: durationType, style: dxSchedulerCore.getAppointmentStyle(geometry), type: type, fromPrev: fromPrev, toNext: toNext, formatDate: formatDate }));
    }))) : (null)); };
    ...
    var ConfirmationDialogBase = function (_a) {
        ...
        return (React.createElement(dxReactCore.Plugin, { name: "ConfirmationDialog", dependencies: pluginDependencies$a },
            !ignoreCancel &&
