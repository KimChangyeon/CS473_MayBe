...
import { createElement, PureComponent, Fragment, createRef, useRef, useState, useCallback } from 'react';
    ...
    AppointmentsBase.prototype.render = function () {
        ...
        return (createElement(Plugin, { name: "Appointments", dependencies: pluginDependencies$2 },
            ...
            createElement(Template, { name: "appointmentContent" }, function (_a) {
                var onClick = _a.onClick, onDoubleClick = _a.onDoubleClick, formatDate = _a.formatDate, data = _a.data, type = _a.type, fromPrev = _a.fromPrev, toNext = _a.toNext, durationType = _a.durationType, restParams = __rest(_a, ["onClick", "onDoubleClick", "formatDate", "data", "type", "fromPrev", "toNext", "durationType"]);
                return (createElement(Appointment, __assign({ data: data }, createClickHandlers(onClick, onDoubleClick), restParams),
                    ...
                    createElement(AppointmentContent, { data: data, type: type, durationType: durationType, recurringIconComponent: recurringIconComponent, formatDate: formatDate }),
...
var prepareChanges = function (appointmentData, editingAppointment, addedAppointment, appointmentChanges) {
    ...
    return { changedAppointment: changedAppointment, isNew: isNew, isFormEdited: isFormEdited };
};
    ...
    AppointmentFormBase.prototype.render = function () {
        ...
        return (createElement(Plugin, { name: "AppointmentForm", dependencies: pluginDependencies$5 },
            ...
            createElement(Template, { name: "schedulerRoot" },
                createElement(TemplateConnector, null, function (_a, _b) {
                    var editingAppointment = _a.editingAppointment, addedAppointment = _a.addedAppointment, appointmentChanges = _a.appointmentChanges;
                    ...
                    var _c = prepareChanges(appointmentData, editingAppointment, addedAppointment, appointmentChanges), changedAppointment = _c.changedAppointment, isNew = _c.isNew;
            ...
            createElement(Template, { name: "commandLayout" },
                createElement(TemplateConnector, null, function (_a, _b) {
                    ...
                    var _c = prepareChanges(appointmentData, editingAppointment, addedAppointment, appointmentChanges), isNew = _c.isNew, changedAppointment = _c.changedAppointment, isFormEdited = _c.isFormEdited;
            ...
            createElement(Template, { name: "basicLayout" },
                createElement(TemplateConnector, null, function (_a, _b) {
                    var editingAppointment = _a.editingAppointment, addedAppointment = _a.addedAppointment, appointmentChanges = _a.appointmentChanges, locale = _a.locale;
                    var changeAppointment = _b.changeAppointment, changeAddedAppointment = _b.changeAddedAppointment;
                    var _c = prepareChanges(appointmentData, editingAppointment, addedAppointment, appointmentChanges), isNew = _c.isNew, changedAppointment = _c.changedAppointment;
                    return (createElement(BasicLayout, { locale: locale, appointmentData: visible ? changedAppointment : previousAppointment, onFieldChange: _this.changeAppointmentField(isNew, changeAddedAppointment, changeAppointment), getMessage: getMessage, readOnly: readOnly, textEditorComponent: textEditorComponent, dateEditorComponent: dateEditorComponent, booleanEditorComponent: booleanEditorComponent, selectComponent: selectComponent, labelComponent: labelComponent, fullSize: !changedAppointment.rRule }));
                })),
...
var renderAppointmentItems = function (items, formatDate, data, Wrapper, Appointment) { return (items.length > 0 ? (createElement(Wrapper, null, items.map(function (_a, index) {
    var dataItem = _a.dataItem, type = _a.type, fromPrev = _a.fromPrev, toNext = _a.toNext, durationType = _a.durationType, geometry = __rest(_a, ["dataItem", "type", "fromPrev", "toNext", "durationType"]);
    return (createElement(Appointment, { key: index.toString(), data: data, durationType: durationType, style: getAppointmentStyle(geometry), type: type, fromPrev: fromPrev, toNext: toNext, formatDate: formatDate }));
}))) : (null)); };
...
var ConfirmationDialogBase = function (_a) {
    ...
    return (createElement(Plugin, { name: "ConfirmationDialog", dependencies: pluginDependencies$a },
        !ignoreCancel &&
...
export { AllDayPanel, AppointmentForm, AppointmentTooltip, Appointments, ConfirmationDialog, DateNavigator, DayView, DragDropProvider, EditRecurrenceMenu, EditingState, IntegratedEditing, MonthView, Scheduler, TodayButton, Toolbar, ViewState, ViewSwitcher, WeekView };
