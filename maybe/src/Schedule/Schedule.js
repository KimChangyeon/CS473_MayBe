	...
	render () {
		const bar =
			<div className="Bar">
				...
				<Popup trigger={<a href="#"><HelpRoundedIcon style={{width: "23px", position: "relative", left: "5px", top: "-1px"}}/></a>} contentStyle={{width: "370px"}}>
					{close => (
						<div className="instruction">
							...
							<ul>
								...
								<li> Drag an appointment to move or resize a schedule.</li>
							</ul>
						</div>
					)}
				</Popup>
